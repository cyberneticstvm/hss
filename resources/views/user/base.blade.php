...
<head>
    ...
    <link rel="stylesheet" href="{{ public_path().'/back-end/plugin/parsleyjs/css/parsley.css' }}">
...
<script src="{{ public_path().'/back-end/bundles/jquery.steps.js' }}"></script>

<script src="{{ public_path().'/back-end/plugin/parsleyjs/js/parsley.min.js' }}"></script>
