            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <h1 class="h4 mt-1">Update Agency</h1>
                    </div>
                </div> <!-- Row end  -->
            </div>
        </div>
                                        ...
                                        <section id="step1">
                                            <div class="row g-4">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" name="name" class="form-control" placeholder="Name of the Agency" data-parsley-required="true" value="{{ $company->name }}" />
                                                    @error('category_id')
                                                ...
                                                <div class="col-sm-4">
                                                    <label class="form-label">Years of Experience <span class="req">*</span>&nbsp;&nbsp;<a href="javascript:void(0)" data-bs-toggle="tooltip" data-placement="top" title="Number of years of experience in Agency services"><i class="fa fa-info text-info"></i></a></label>
                                        ...
                                        <section>
                                            <div class="row g-4">
                                                <div class="col-sm-12 table-responsive">
                                                    ...
                                                    <table class="table table-sm">
                                                        <thead><tr><th>Name of the Waste<br>Management Project</th><th>Client Name</th><th>Project Cost (Rs.)</th><th>Project Period (Yrs)</th><th>Project Start Date</th><th>Project Status</th><th></th></tr></thead>
