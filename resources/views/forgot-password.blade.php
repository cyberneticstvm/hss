                ...
                <div class="row g-0">
                    ...
                    <div class="col-lg-12 d-flex justify-content-center align-items-center border-0 rounded-lg auth-h100">
                        <div class="w-100 p-4 p-md-5 card border-0" style="max-width: 32rem;">
                            <!-- Form -->
                            <form class="row g-1 p-0 p-md-4" method="post" action="{{ route('forgotpwdmail') }}">
                                @csrf
                                <div class="col-12 text-center mb-5">
                                    <p>Enter your email address and you will recive an email to reset your Password. </p>
                                ...
                                <div class="col-12 text-center mt-4">
                                    <button type="submit" class="btn btn-submit btn-block btn-primary lift text-uppercase">SEND EMAIL</button>
                                </div>
