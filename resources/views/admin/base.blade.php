    ...
    <div class="sidebar px-3 py-2 py-md-3">
        <div class="d-flex flex-column h-100">
            ...
            <ul class="menu-list flex-grow-1">
                ...
                <li class="collapsed">
                    <a class="m-link"  data-bs-toggle="collapse" data-bs-target="#menu-Pages"  href="#"><i class="fa fa-file"></i> <span>Emapnel List</span> <span class="arrow fa fa-angle-down ms-auto text-end"></span></a>

                    <!-- Menu: Sub menu ul -->
                    <ul class="sub-menu collapse" id="menu-Pages">
                        <li><a class="ms-link" href="/admin/empanel-list/1/">Submitted</a></li>
                        <li><a class="ms-link" href="/admin/empanel-list/3/">Incompleted</a></li>
                        <li><a class="ms-link" href="/admin/empanel-list/2/">Under Review</a></li>
                        <li><a class="ms-link" href="/admin/empanel-list/4/">Shortlisted</a></li>
                        <li><a class="ms-link" href="/admin/empanel-list/5/">Approved</a></li>
                        <li><a class="ms-link" href="/admin/empanel-list/6/">Rejected</a></li>
                        <li><a class="ms-link" href="/admin/empanel-list/7/">Blacklisted</a></li>
                    </ul>
                </li>

                <li class="collapsed">
                    <a class="m-link"  data-bs-toggle="collapse" data-bs-target="#menu-Settings"  href="#"><i class="fa fa-gear"></i> <span>Settings</span> <span class="arrow fa fa-angle-down ms-auto text-end"></span></a>

                    <!-- Menu: Sub menu ul -->
                    <ul class="sub-menu collapse" id="menu-Settings">
                        <li><a class="ms-link" href="/admin/settings/cut-off-mark/">Cut off Mark</a></li>
                        <li><a class="ms-link" href="/admin/settings/fyear/">Financial Year</a></li>
                    </ul>
                </li>
            </ul>
